...
# Paths
gender_path = os.path.join(ROOT_DIR, "results_gender.json")
language_path = os.path.join(ROOT_DIR, "results_languages.json")
academia_path = os.path.join(ROOT_DIR, "results_academia.json")
geo_path = os.path.join(ROOT_DIR, "results_geographic_proximity.json")
age_difference_path = os.path.join(ROOT_DIR, "results_age_difference.json")
output_path = os.path.join(ROOT_DIR, "results_final.json")
